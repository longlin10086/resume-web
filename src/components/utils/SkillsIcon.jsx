    ...
    <div className="my-2 flex items-center flex-wrap">
      {skills.map((skill, index) => {
        return (
          <div
            key={index}
            className="group flex justify-center items-center border-2 rounded-xl mx-1 mb-1 hover:shadow-lg hover:ring-2 hover:ring-blue-500/50 ease-in-out duration-500"
          >
            <img
